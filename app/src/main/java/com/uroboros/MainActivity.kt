...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
         ...
         * этой длины недостижим: при наблюдавшихся 163–212 мс на токен 512
         ...
         *
         * СЕЙЧАС ОНО ПОДНЯТО РАДИ ТАКОГО ЗАМЕРА и подлежит возврату на 512
         * сразу после него. Замеряется, что происходит между требованием
         * остановки и концом потока: продолжает ли считать железо или
         * разбирается уже накопленное.
         */
