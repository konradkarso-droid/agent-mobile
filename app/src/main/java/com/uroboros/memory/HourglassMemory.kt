...
class HourglassMemory(
     ...
     *
     * УЧЁТ. Исход каждой проверки идёт в прибор очереди, включая чистую: без
     * счёта чистых проверок ноль дел неотличим от неработающего прибора. Спор
     * и сбой считаются порознь — по базе они неразличимы, по счёту входов
     * различимы.
     *
