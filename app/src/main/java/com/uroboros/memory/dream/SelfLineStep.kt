...
/**
 * Шаг ночи по кнопке «строка о себе»: прочитать, что известно, решить
 ...
 *
 * Зовёт только ночь по кнопке (AgentService.startNight), после судьи.
 * Самостоятельный сон и самостоятельный судья строку не предлагают.
 *
