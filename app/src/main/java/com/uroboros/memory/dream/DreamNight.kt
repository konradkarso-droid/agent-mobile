...
data class DreamNight(
    ...
    /**
     * Итог шага «строка о себе» этой ночи — та же строка, что в отчёте ночи
     * (см. [SelfLineStep]). null — шага не было: ночь без кнопки
     * (самостоятельный сон строку не предлагает) или ночь прошла раньше, чем
     * шаг появился. Это правда, а не пропуск: выдумывать итог шагу, которого
     * не было, нельзя.
     *
     * Пишется не вставкой ночи, а отдельным обновлением после судьи: шаг идёт
