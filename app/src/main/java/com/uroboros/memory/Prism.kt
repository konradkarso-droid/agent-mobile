...
object Prism {
     ...
     * и подписана как правила. Запись из RED приходит к модели иначе —
     * цитатой памяти («Пользователь сказал: …»), и правило, положенное сюда,
     * модель прочла бы как воспоминание.
     *
