 ...
 *  - база отдаёт по ступени не больше CANDIDATE_LIMIT записей из всех слоёв
 *    сразу, а слой отсекается уже после. Частое слово, набравшее двадцать
 *    горячих записей, заслонит холодную, и холод скажет «искал — пусто»;
